package com.lasanthasuresh.test.repository;

import com.lasanthasuresh.test.JhipsterSampleApplicationApp;
import com.lasanthasuresh.test.config.Constants;
import com.lasanthasuresh.test.config.audit.AuditEventConverter;
import com.lasanthasuresh.test.domain.PersistentAuditEvent;
...
import static com.lasanthasuresh.test.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
